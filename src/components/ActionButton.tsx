...
const ActionButton: FC<ActionButtonProps> = ({
  ...
  const baseClasses =
    "align-middle border font-mono inline-flex items-center justify-center shadow-sm disabled:cursor-not-allowed disabled:opacity-70 disabled:pointer-events-none disabled:shadow-none focus:ring-1 focus:ring-black focus:ring-offset-2";
