...
const LinkButton: FC<LinkButtonProps> = ({
  ...
  const baseClasses =
    "align-middle border font-mono inline-flex items-center justify-center no-underline shadow-sm text-center focus:ring-1 focus:ring-black focus:ring-offset-2";
